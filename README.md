...
### Podcast pipeline runbook (ops/setup)

For the exact implementation paths, required config, runtime folder layout under `~/.openclaw/podcasts`, API flow, and handoff checklist, see:

- [`workspace/MISSION_CONTROL_MANUAL.md`](./workspace/MISSION_CONTROL_MANUAL.md)
